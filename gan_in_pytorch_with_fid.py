...
num_workers = max(0, torch.multiprocessing.cpu_count() - 2)  # Subtract 1 to reserve a core for main processes
...
if __name__ == "__main__":
    ...
    # Enable cuDNN benchmark mode if CUDA is available
    ...
    dataset = MyDataModule(root_dir="./seg_train/seg_train", transform=transform)
    ...
    # Establish convention for real and fake labels during training, adding label smoothing
    real_label = 0.9
    fake_label = 0.1
    ...
    for epoch in tqdm(range(num_epochs)):
        ...
        # if (epoch + 1) % 5 == 0:
        #     print(
        #         "[%d/%d]\tLoss_D: %.4f\tLoss_G: %.4f\tFretchet_Distance: %.4f"
        ...
        #         fake_display[torch.randint(len(fake_display), (10,))], nrow=5, padding=2, normalize=True
        #     )
